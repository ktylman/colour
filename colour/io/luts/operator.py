...
class LUTOperatorMatrix(AbstractLUTSequenceOperator):
    ...
    def __init__(self,
        ...
        self.matrix = (self._matrix if matrix is None else
                       matrix)  # type: ignore[assignment]
        self._offset: NDArray = zeros(4)
        self.offset = (self._offset if offset is None else
                       offset)  # type: ignore[assignment]
