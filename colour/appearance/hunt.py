...
s=0.0199093..., Q=22.2097654..., M=0.1238964..., H=None, HC=None)
    ...
    if L_AS is None and CCT_w is None:
        ...
        L_AS = illuminant_scotopic_luminance(L_A,
                                             CCT_w)  # type: ignore[arg-type]
        usage_warning(
    ...
    A = achromatic_signal(L_AS, S_p, S_w_p, N_bb, A_a)
    A_w = achromatic_signal(L_AS, S_w_p, S_w_p, N_bb, A_aw)
